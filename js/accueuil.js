...
//On fait une recherche en fonction du select
    ...
    if(select==='Style'){
        ajaxRequest('GET','../class/request.php/filtrer_style?search='+search,recherche_album)
    }
    if(select==='Annee'){
        ajaxRequest('GET','../class/request.php/filtrer_annee?search='+search,recherche_album)
    }
